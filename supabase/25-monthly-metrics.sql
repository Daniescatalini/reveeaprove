...
alter table public.monthly_metrics
  ...
  add column if not exists instagram_saves integer,
  add column if not exists instagram_shares integer,
  add column if not exists instagram_reposts integer,
